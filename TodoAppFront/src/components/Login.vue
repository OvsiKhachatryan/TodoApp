    ...
    <div class="main d-flex justify-content-center align-items-center">
        <div class="section d-flex justify-content-center align-items-center">
            <div class="auth-section mt-5">
                <h3 class="text-secondary text-center mt-5">Sign in</h3>
                <form @submit.prevent="submit" class="p-3">
                    ...
                    <router-link class="forgot-pass text-secondary text-decoration-none ms-4" to="/forgot-password">
                        Forgot password?
                    </router-link>
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn sign-btn me-3">Sign in</button>
                    </div>
                    <p class="error" v-if="errors">{{ errors }}</p>
                    <div class="d-flex justify-content-center mt-4">
                        <p class="text-secondary me-2">Don't have an account?</p>
                        <router-link class="auth-text text-decoration-none" to="/register">Sign up</router-link>
                    </div>
                </form>
            </div>
